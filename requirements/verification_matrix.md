...
| T-SIM-004 | 10,000-case tolerance/environment sweep | Yes | `simulation/output/simulation.json` |
...
| T-PCB-004 | Main-board unrouted-count gate | Yes | `hardware/ir_spoke_link/drc.rpt`; currently open |
